...
import { layout } from "./pages/layout.js?v=2026050128";
...
import { tenantsPage } from "./pages/tenants.js?v=2026050126";
import { adminDashboard } from "./pages/adminDashboard.js?v=2026050127";
import { memberDashboard } from "./pages/memberDashboard.js?v=2026050123";
import { coachDashboard } from "./pages/coachDashboard.js?v=2026050123";
import { reservationsPage } from "./pages/reservations.js?v=2026050128";
import { classesPage } from "./pages/classes.js?v=2026050123";
import { membersPage } from "./pages/members.js?v=2026050123";
import { coachesPage } from "./pages/coaches.js?v=2026050123";
import { paymentsPage } from "./pages/payments.js?v=2026050123";
import { settingsPage } from "./pages/settings.js?v=2026050123";
import { profilePage } from "./pages/profile.js?v=2026050123";
import { courtsPage } from "./pages/courts.js?v=2026050123";
import { wireGlobalSearch } from "./components/navbar.js?v=2026050128";
