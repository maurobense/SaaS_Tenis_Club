...
import { loginPage } from "./pages/login.js?v=2026050201";
import { superAdminDashboard } from "./pages/superAdminDashboard.js?v=2026050126";
import { tenantsPage } from "./pages/tenants.js?v=2026050202";
import { adminDashboard } from "./pages/adminDashboard.js?v=2026050155";
import { memberDashboard } from "./pages/memberDashboard.js?v=2026050157";
import { coachDashboard } from "./pages/coachDashboard.js?v=2026050157";
import { reservationsPage } from "./pages/reservations.js?v=2026050157";
import { classesPage } from "./pages/classes.js?v=2026050157";
import { membersPage } from "./pages/members.js?v=2026050157";
import { coachesPage } from "./pages/coaches.js?v=2026050157";
import { paymentsPage } from "./pages/payments.js?v=2026050156";
import { settingsPage } from "./pages/settings.js?v=2026050202";
import { profilePage } from "./pages/profile.js?v=2026050131";
import { courtsPage } from "./pages/courts.js?v=2026050157";
import { wireGlobalSearch } from "./components/navbar.js?v=2026050145";
